    ...
    return (
        <div className="flex justify-center min-h-screen">
            <div className="flex flex-col justify-center p-8 bg-white shadow-md rounded-lg min-h-screen w-[900px]">
                ...
                <form className="flex flex-col justify-center max-w-[400px] mx-auto w-[100%] mt-[65px]">
                    <div >
                        <label htmlFor="username" className="block text-sm font-medium text-gray-700 pl-[24px] pb-[12px] font-ubuntu">
                            E-mail:
                        </label>
